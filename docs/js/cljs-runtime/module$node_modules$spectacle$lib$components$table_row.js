...
newObj[key]=obj[key]}newObj.default=obj;return newObj}(require("module$node_modules$react$index"));global=_interopRequireDefault(require("module$node_modules$prop_types$index"));var _base=require("module$node_modules$spectacle$lib$utils$base");require=_interopRequireDefault(require("module$node_modules$react_emotion$dist$index_cjs"));var StyledTableRow=(0,require.default)("tr",{target:"emir1a80"})(function(props){return props.styles});require=function(_Component){function TableRow(){if(!(this instanceof
TableRow))throw new TypeError("Cannot call a class as a function");var call=_getPrototypeOf(TableRow).apply(this,arguments);if(!call||"object"!==_typeof(call)&&"function"!==typeof call){if(void 0===this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");call=this}return call}_inherits(TableRow,_Component);_createClass(TableRow,[{key:"render",value:function(){return _react.default.createElement(StyledTableRow,{className:this.props.className,styles:[this.context.styles.components.tableRow,
_base.getStyles.call(this),this.props.style]},this.props.children)}}]);return TableRow}(_react.Component);exports.default=require;require.propTypes={children:global.default.node,className:global.default.string,style:global.default.object};require.contextTypes={styles:global.default.object,store:global.default.object}}
//# sourceMappingURL=module$node_modules$spectacle$lib$components$table_row.js.map
