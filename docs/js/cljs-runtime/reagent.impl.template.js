...
var G__5568 = o;
(G__5568[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__5570__i = 0, G__5570__a = new Array(arguments.length -  0);
while (G__5570__i < G__5570__a.length) {G__5570__a[G__5570__i] = arguments[G__5570__i + 0]; ++G__5570__i;}
  args = new cljs.core.IndexedSeq(G__5570__a,0,null);
} 
return G__5569__delegate.call(this,args);};
G__5569.cljs$lang$maxFixedArity = 0;
G__5569.cljs$lang$applyTo = (function (arglist__5571){
var args = cljs.core.seq(arglist__5571);
...
var G__5572 = o;
(G__5572[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__5573__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__5573 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__5574__i = 0, G__5574__a = new Array(arguments.length -  0);
while (G__5574__i < G__5574__a.length) {G__5574__a[G__5574__i] = arguments[G__5574__i + 0]; ++G__5574__i;}
  args = new cljs.core.IndexedSeq(G__5574__a,0,null);
} 
return G__5573__delegate.call(this,args);};
G__5573.cljs$lang$maxFixedArity = 0;
G__5573.cljs$lang$applyTo = (function (arglist__5575){
var args = cljs.core.seq(arglist__5575);
return G__5573__delegate(args);
});
...
var G__5582 = props;
var G__5582__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5582,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__5582);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5582__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__5588){
var map__5589 = p__5588;
var map__5589__$1 = ((((!((map__5589 == null)))?(((((map__5589.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5589.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5589):map__5589);
var props = map__5589__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5589__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__5589,map__5589__$1,props,class$){
return (function (c){
...
});})(map__5589,map__5589__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__5633){
var map__5634 = p__5633;
var map__5634__$1 = ((((!((map__5634 == null)))?(((((map__5634.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5634.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5634):map__5634);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5634__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__5634,map__5634__$1,on_write){
return (function (){
...
});})(node_value,map__5634,map__5634__$1,on_write))
);
} else {
...
var G__5657 = jsprops;
(G__5657["defaultValue"] = value);

(G__5657["onChange"] = ((function (G__5657,v,value,on_change){
return (function (p1__5653_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5653_SHARP_);
});})(G__5657,v,value,on_change))
);
...
var vec__5662 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5662,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5662,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5662,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___5669 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___5669 == null)){
} else {
var key_5671 = temp__5461__auto___5669;
(jsprops["key"] = key_5671);
}
...
var temp__5461__auto___5674 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___5674 == null)){
} else {
var key_5675 = temp__5461__auto___5674;
reagent.impl.template.oset(jsprops,"key",key_5675);
}
...
var G__5676 = reagent.impl.template.__GT_NativeWrapper();
(G__5676["name"] = c);
...
var G__5681 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5681) : reagent.impl.template.as_element.call(null,G__5681));
} else {
...
var len__4531__auto___5689 = arguments.length;
var i__4532__auto___5690 = (0);
while(true){
if((i__4532__auto___5690 < len__4531__auto___5689)){
args__4534__auto__.push((arguments[i__4532__auto___5690]));

var G__5691 = (i__4532__auto___5690 + (1));
i__4532__auto___5690 = G__5691;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5686){
var G__5687 = cljs.core.first(seq5686);
var seq5686__$1 = cljs.core.next(seq5686);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__5687,seq5686__$1);
});
...
break;
default:
var G__5701 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__5701;
continue;
...
var n__4408__auto___5703 = a.length;
var i_5704 = (0);
while(true){
if((i_5704 < n__4408__auto___5703)){
(a[i_5704] = reagent.impl.template.as_element((a[i_5704])));

var G__5708 = (i_5704 + (1));
i_5704 = G__5708;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___5709 = a.length;
var i_5710 = (0);
while(true){
if((i_5710 < n__4408__auto___5709)){
var val_5711 = (a[i_5710]);
if(((cljs.core.vector_QMARK_(val_5711)) && ((reagent.impl.template.key_from_vec(val_5711) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_5710] = reagent.impl.template.as_element(val_5711));
...
var ctx = ({});
var vec__5713 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5713,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5713,(1),null);
...
var G__5718 = (cljs.core.count(argv) - first_child);
switch (G__5718) {
case (0):
...
var G__5719 = comp;
var G__5720 = jsprops;
var G__5721 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__5719,G__5720,G__5721);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__5718){
