...
if((i < len)){
var k = (ks[i]);
var G__5374 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__5375 = (i + (1));
m = G__5374;
i = G__5375;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__5379 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__5379);
})());
} else {
var v = temp__5459__auto__;
...
return (G__5383__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__5386 = c;
var G__5386__$1 = (((G__5386 == null))?null:G__5386.prototype);
if((G__5386__$1 == null)){
return null;
} else {
return (G__5386__$1["render"]);
}
})() == null))));
});
...
var G__5410 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__5410) : reagent.impl.component.as_element.call(null,G__5410));
};
...
while (G__5415__i < G__5415__a.length) {G__5415__a[G__5415__i] = arguments[G__5415__i + 0]; ++G__5415__i;}
  args = new cljs.core.IndexedSeq(G__5415__a,0,null);
} 
...
var _STAR_current_component_STAR_5418 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_5418;
}});
...
return ((function (G__5460,G__5460__$1){
...
var c = this;
var G__5492_5495 = (c["cljsRatom"]);
if((G__5492_5495 == null)){
} else {
reagent.ratom.dispose_BANG_(G__5492_5495);
}
...
var render_fun_5510 = cljs.core.first(cljs.core.vals(renders_5509));
if((cljs.core.count(renders_5509) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_5509))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_5510)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_5510], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__5508 = name;
switch (G__5508) {
case "":
...
var G__5517 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__5517);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__5520 = fiber;
...
var parent = (function (){var G__5521 = fiber;
if((G__5521 == null)){
return null;
} else {
return (G__5521["return"]);
}
})();
var path = (function (){var G__5522 = parent;
var G__5522__$1 = (((G__5522 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__5522) : reagent.impl.component.fiber_component_path.call(null,G__5522)));
if((G__5522__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5522__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__5524 = c;
if((G__5524 == null)){
return null;
} else {
return (G__5524["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__5525._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__5527 = c;
if((G__5527 == null)){
return null;
} else {
return (G__5527["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__5529 = c;
if((G__5529 == null)){
return null;
} else {
return G__5529._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__5532 = instance;
if((G__5532 == null)){
return null;
} else {
return (G__5532["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__5534 = instance;
if((G__5534 == null)){
return null;
} else {
return G__5534._currentElement;
}
}
})();
var name = (function (){var G__5535 = elem;
var G__5535__$1 = (((G__5535 == null))?null:(G__5535["type"]));
if((G__5535__$1 == null)){
return null;
} else {
return (G__5535__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__5537 = elem;
if((G__5537 == null)){
return null;
} else {
return (G__5537["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__5538._owner;
}
}
})();
var path = (function (){var G__5540 = owner;
var G__5540__$1 = (((G__5540 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__5540) : reagent.impl.component.component_path.call(null,G__5540)));
if((G__5540__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__5540__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__5545 = c;
var G__5545__$1 = (((G__5545 == null))?null:G__5545.constructor);
if((G__5545__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__5545__$1);
}
}
})();
