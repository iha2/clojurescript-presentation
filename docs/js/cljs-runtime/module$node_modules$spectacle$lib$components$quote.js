...
newObj[key]=obj[key]}newObj.default=obj;return newObj}(require("module$node_modules$react$index"));global=_interopRequireDefault(require("module$node_modules$prop_types$index"));var _base=require("module$node_modules$spectacle$lib$utils$base");require=_interopRequireDefault(require("module$node_modules$react_emotion$dist$index_cjs"));var StyledQuote=(0,require.default)("span",{target:"e17e9dpw0"})(function(props){return props.styles});require=function(_Component){function Quote(){if(!(this instanceof
Quote))throw new TypeError("Cannot call a class as a function");var call=_getPrototypeOf(Quote).apply(this,arguments);if(!call||"object"!==_typeof(call)&&"function"!==typeof call){if(void 0===this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");call=this}return call}_inherits(Quote,_Component);_createClass(Quote,[{key:"render",value:function(){var typefaceStyle=this.context.typeface||{};return _react.default.createElement(StyledQuote,{className:this.props.className,
styles:[this.context.styles.components.quote,_base.getStyles.call(this),typefaceStyle,this.props.style]},this.props.children)}}]);return Quote}(_react.Component);exports.default=require;require.propTypes={children:global.default.node,className:global.default.string,style:global.default.object};require.contextTypes={styles:global.default.object,store:global.default.object,typeface:global.default.object}}
//# sourceMappingURL=module$node_modules$spectacle$lib$components$quote.js.map
